        ...
        var DefaultViewModel = (function (_super) {
            ...
            DefaultViewModel.prototype.Load = function () {
                ...
                for (var i = 0; i < t.length; i++) {
                    var team = new NflDraft.Models.Team();
                ...
                for (var i = 0; i < p.length; i++) {
                    var player = new NflDraft.Models.Player();
                ...
                for (var i = 0; i < ps.length; i++) {
                    var playerStats = new NflDraft.Models.PlayerStats();
                    playerStats.Player = _players[ps[i]["Player"]];
                    playerStats.ADP = ps[i]["ADP"];
                    if (ps[i]["Projected"]) {
                        var projected = new NflDraft.Models.Stats();
