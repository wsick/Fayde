...
class DefaultViewModel extends Fayde.MVVM.ViewModelBase {
    ...
    DraftSelections = new Fayde.Collections.ObservableCollection<DraftSelection>();
    Positions: string[] = [];
    FantasyTeams: FantasyTeam[] = [];
    FantasyPlayers = new Fayde.Collections.ObservableCollection<FantasyPlayer>();
    ChatMessages = new Fayde.Collections.ObservableCollection<ChatMessage>();
    ...
    private _current_draft_spot: DraftSpot = null;
    ...
    Load() {
        ...
        for (var i = 0; i < ft.length; i++) {
            this.FantasyTeams.push(new FantasyTeam(ft[i], fantasy_positions));
        }
