...
function FrameworkElement() {
    UIElement.apply(this);
    this.GetActualWidth = function () {
        return this.ActualWidth;
    };
    this.SetActualWidth = function (value) {
        this.ActualWidth = value;
    };
    this.GetActualHeight = function () {
        return this.ActualHeight;
    };
    this.SetActualHeight = function (value) {
    ...
    this.GetHorizontalAlignment = function () {
        return this.HorizontalAlignment;
    };
    this.SetHorizontalAlignment = function (value) {
        this.HorizontalAlignment = value;
    };
    this.GetVerticalAlignment = function () {
        return this.VerticalAlignment;
    };
    this.SetVerticalAlignment = function (value) {
        this.VerticalAlignment = value;
    };
    this._ApplySizeConstraints = function (size) {
    ...
    this._ApplyTemplateWithError = function (error) {
        NotImplemented();
    };
    ...
    this._MeasureOverrideWithEror = function (availableSize) {
    ...
    this._ArrangeOverrideWithError = function (finalSize, error) {
