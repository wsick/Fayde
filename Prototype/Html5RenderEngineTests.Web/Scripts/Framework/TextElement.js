...
RefObject.Register(TextElement, DependencyObject);
...
RefObject.Register(Inline, TextElement);
...
RefObject.Register(Span, Inline);
...
RefObject.Register(LineBreak, Inline);
...
RefObject.Register(Hyperlink, Span);
...
RefObject.Register(Block, TextElement);
...
RefObject.Register(Paragraph, Block);
...
RefObject.Register(Section, TextElement);
