...
namespace Parser.Elements
{
    ...
    public class Page: FrameworkElement
    {
        ...
        public override string ToString()
        {
            ...
            sb.AppendLine("<script src=\"../../Scripts/Framework/NotifyProperty.js\" type=\"text/javascript\"></script>");
            sb.AppendLine("<script src=\"../../Scripts/Framework/Primitives.js\" type=\"text/javascript\"></script>");
            sb.AppendLine("<script src=\"../../Scripts/Framework/PropertyPath.js\" type=\"text/javascript\"></script>");
