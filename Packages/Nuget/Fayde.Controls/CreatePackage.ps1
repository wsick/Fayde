...
copy ($PWD.Path + "\..\..\..\Source\Fayde.Controls.Ex\Themes\Default.theme.xml") ($libdestdir + "\Themes\")
copy ($PWD.Path + "\..\..\..\Source\Fayde.Controls.Ex\Themes\Metro.theme.xml") ($libdestdir + "\Themes\")
