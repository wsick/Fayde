...
declare module Fayde.Controls {
    ...
    interface IItemContainerGenerator {
        ...
        PrepareItemContainer(container: Fayde.DependencyObject);
    ...
    class ItemContainerGenerator implements IItemContainerGenerator, IRecyclingItemContainerGenerator {
        ...
        private _Items;
        public ItemsChanged: MulticastEvent<Fayde.Controls.Primitives.ItemsChangedEventArgs>;
...
declare module Fayde {
    class VisualTreeHelper {
        ...
        private static _SerializeDirt(dirt);
        private static _SerializeFlags(flags);
...
declare module Fayde.Providers {
    ...
    interface IPropertyChangedListener {
        ...
        OnPropertyChanged(sender: Fayde.DependencyObject, args: IDependencyPropertyChangedEventArgs);
        Detach();
    }
...
declare module Fayde {
    class XamlResolver {
        public OnSuccess: (xamlResult: Fayde.AjaxJsonResult, scriptResult: HTMLScriptElement) => void;
        public OnSubSuccess;
        ...
        private _XamlResult;
        constructor(OnSuccess: (xamlResult: Fayde.AjaxJsonResult, scriptResult: HTMLScriptElement) => void, OnSubSuccess, OnError: (error: string) => void);
...
declare module Fayde.Collections {
    interface INotifyCollectionChanged {
        CollectionChanged: MulticastEvent<Fayde.Collections.NotifyCollectionChangedEventArgs>;
    }
...
declare module Fayde {
    class FrameworkTemplate {
        public ResChain: Fayde.ResourceDictionary[];
    }
}
declare module Fayde {
...
declare module Fayde {
    class StaticResourceExpression extends Fayde.Expression {
        private _Key;
        private _Target;
        private _Property;
        private _PropertyName;
        private _ResChain;
        constructor(key, target: Fayde.XamlObject, propd: DependencyProperty, propName: string, templateBindingSource: Fayde.XamlObject, resChain: Fayde.ResourceDictionary[]);
        public GetValue(propd: DependencyProperty): any;
        private _GetValue(resChain);
        public Resolve(parser: Fayde.JsonParser): void;
    }
}
declare module Fayde {
...
declare class App implements Fayde.IResourcable, Fayde.ITimerListener {
    ...
    private _ClockTimer;
    private static _GenericResourceDictionary;
    constructor();
...
declare module Fayde {
    ...
    class DebugInterop {
        ...
        private static _StringifyReplacer(key, value);
    }
}
...
declare module Fayde {
    ...
    class JsonParser {
        ...
        static Parse(json: any, templateBindingSource?: Fayde.DependencyObject, namescope?: Fayde.NameScope, resChain?: Fayde.ResourceDictionary[], rootXamlObject?: Fayde.XamlObject): any;
        static ParseUserControl(uc: Fayde.Controls.UserControl, json: any): Fayde.UIElement;
        static ParseResourceDictionary(rd: Fayde.ResourceDictionary, json: any): void;
        static ParsePage(json: any): Fayde.Controls.Page;
        public CreateObject(json: any, namescope: Fayde.NameScope, ignoreResolve?: boolean): any;
        public SetObject(json: any, xobj: Fayde.XamlObject, namescope: Fayde.NameScope, ignoreResolve?: boolean): any;
        public TrySetPropertyValue(xobj: Fayde.XamlObject, propd: DependencyProperty, propValue: any, namescope: Fayde.NameScope, isAttached: boolean, ownerType: Function, propName: string): void;
        public TrySetCollectionProperty(subJson: any[], xobj: Fayde.XamlObject, propd: DependencyProperty, propertyName: string, namescope: Fayde.NameScope): boolean;
        public SetResourceDictionary(rd: Fayde.ResourceDictionary, json: any, namescope: Fayde.NameScope): void;
        public ResolveStaticResourceExpressions(): void;
        public SetValue(xobj: Fayde.XamlObject, propd: DependencyProperty, propName: string, value: any): void;
        private GetAnnotationMember(type, member);
    }
}
declare module Fayde {
    class Markup {
        public Transmute(target: Fayde.XamlObject, propd: DependencyProperty, propName: string, templateBindingSource: Fayde.DependencyObject, resChain: Fayde.ResourceDictionary[]): void;
    }
}
declare module Fayde {
    class StaticResourceMarkup extends Fayde.Markup {
        public Key: any;
        constructor(key: any);
        public Transmute(target: Fayde.XamlObject, propd: DependencyProperty, propName: string, templateBindingSource: Fayde.DependencyObject, resChain: Fayde.ResourceDictionary[]): Fayde.StaticResourceExpression;
    }
}
declare module Fayde {
    class TemplateBindingMarkup extends Fayde.Markup {
        public Path: string;
        constructor(path: string);
        public Transmute(target: Fayde.XamlObject, propd: DependencyProperty, propName: string, templateBindingSource: Fayde.DependencyObject, resChain: Fayde.ResourceDictionary[]): Fayde.TemplateBindingExpression;
    }
}
declare module Fayde.Media {
...
declare module Fayde.Controls {
    class ControlTemplate extends Fayde.FrameworkTemplate {
        private _TempJson;
        public TargetType: Function;
        constructor(targetType: Function, json: any);
        public GetVisualTree(templateBindingSource: Fayde.DependencyObject): Fayde.UIElement;
    }
}
declare module Fayde.Controls {
    class ItemsPanelTemplate extends Fayde.FrameworkTemplate {
        private _TempJson;
        constructor(json: any);
        public GetVisualTree(templateBindingSource: Fayde.DependencyObject): Controls.Panel;
    }
}
declare module Fayde.Controls.Primitives {
...
declare module Fayde {
    class DataTemplate extends Fayde.FrameworkTemplate {
        private _TempJson;
        constructor(json: any);
        public GetVisualTree(templateBindingSource?: Fayde.DependencyObject): Fayde.UIElement;
    }
...
declare module Fayde {
    ...
    interface INotifyPropertyChanged {
        PropertyChanged: MulticastEvent<Fayde.PropertyChangedEventArgs>;
    }
    var INotifyPropertyChanged_: IInterfaceDeclaration;
}
declare module Fayde {
    class ResourceTarget extends Fayde.XamlObject {
        private _Json;
        private _Namescope;
        private _TemplateBindingSource;
        private _ResChain;
        constructor(json: any, namescope: Fayde.NameScope, templateBindingSource: Fayde.DependencyObject, resChain: Fayde.ResourceDictionary[]);
        public CreateResource(): Fayde.XamlObject;
    }
}
declare module Fayde {
...
declare module Fayde {
    class RoutedPropertyChangedEvent<T> extends Fayde.RoutedEvent<Fayde.RoutedPropertyChangedEventArgs<T>> {
    }
...
declare module Fayde.Data {
    ...
    class Binding extends Data.BindingBase {
...
declare module Fayde.Input {
    class KeyInterop {
        ...
        public CreateArgsPress(e): Input.KeyEventArgs;
        public CreateArgsDown(e): Input.KeyEventArgs;
...
declare module Fayde {
    interface IBindingData {
        Path: string;
        FallbackValue: any;
        Mode: Fayde.Data.BindingMode;
        StringFormat: string;
        ElementName: string;
    }
    class BindingMarkup extends Fayde.Markup {
        private _Data;
        constructor(data: any);
        public Transmute(target: Fayde.XamlObject, propd: DependencyProperty, propName: string, templateBindingSource: Fayde.DependencyObject, resChain: Fayde.ResourceDictionary[]): Fayde.Data.BindingExpression;
...
declare module Fayde.Media {
    ...
    class GeometryCollection extends Fayde.XamlObjectCollection<Fayde.Media.Geometry> implements IGeometryListener {
        private _Listener;
        public Listen(listener: IGeometryListener): void;
        public Unlisten(listener: IGeometryListener): void;
...
declare module Fayde.Media {
    ...
    class GradientStopCollection extends Fayde.XamlObjectCollection<Fayde.Media.GradientStop> implements IGradientStopListener {
        private _Listener;
...
declare module Fayde.Media {
    ...
    class PathFigureCollection extends Fayde.XamlObjectCollection<Fayde.Media.PathFigure> implements IPathFigureListener {
        private _Listener;
...
declare module Fayde.Media {
    ...
    class PathSegmentCollection extends Fayde.XamlObjectCollection<Fayde.Media.PathSegment> implements IPathSegmentListener {
        private _Listener;
...
declare module Fayde.Media {
    ...
    class TransformCollection extends Fayde.XamlObjectCollection<Fayde.Media.Transform> {
        private _Relayer;
...
declare module Fayde.Media.Animation {
    ...
    class KeyFrameCollection extends Fayde.XamlObjectCollection<Fayde.Media.Animation.KeyFrame> {
        private _Resolved;
        private _SortedList;
...
declare module Fayde.Media.Animation {
    ...
    class TimelineCollection extends Fayde.XamlObjectCollection<Fayde.Media.Animation.Timeline> {
    }
}
...
declare module Fayde.Media.VSM {
    ...
    class VisualStateCollection extends Fayde.XamlObjectCollection<Fayde.Media.VSM.VisualState> {
    }
}
declare module Fayde.Media.VSM {
    ...
    class VisualStateGroup extends Fayde.DependencyObject {
        ...
        public CurrentStateChanging: MulticastEvent<Fayde.Media.VSM.VisualStateChangedEventArgs>;
        public CurrentStateChanged: MulticastEvent<Fayde.Media.VSM.VisualStateChangedEventArgs>;
    ...
    class VisualStateGroupCollection extends Fayde.XamlObjectCollection<Fayde.Media.VSM.VisualStateGroup> {
    }
}
declare module Fayde.Media.VSM {
...
declare module Fayde.Controls {
    ...
    class ColumnDefinitionCollection extends Fayde.XamlObjectCollection<Fayde.Controls.ColumnDefinition> implements IColumnDefinitionListener {
        private _Listener;
...
declare module Fayde.Controls {
    ...
    class ItemCollection extends Fayde.XamlObjectCollection<Fayde.XamlObject> implements IItemCollection, IItemCollectionHidden {
...
declare module Fayde.Controls {
    ...
    class RowDefinitionCollection extends Fayde.XamlObjectCollection<Fayde.Controls.RowDefinition> implements IRowDefinitionListener {
        private _Listener;
...
declare module Fayde {
    ...
    class ResourceDictionaryCollection extends Fayde.XamlObjectCollection<Fayde.ResourceDictionary> {
    ...
    class ResourceDictionary extends Fayde.XamlObjectCollection<Fayde.XamlObject> {
        private _KeyIndex;
        public MergedDictionaries: ResourceDictionaryCollection;
        public Source: string;
        constructor();
        public ContainsKey(key: any): boolean;
        public Get(key: any): Fayde.XamlObject;
        public Set(key: any, value: Fayde.XamlObject): boolean;
        public Add(value: Fayde.XamlObject): number;
        public Remove(value: Fayde.XamlObject): boolean;
...
declare module Fayde {
    class SetterCollection extends Fayde.XamlObjectCollection<Fayde.Setter> {
        private _IsSealed;
...
declare module Fayde {
    ...
    class TriggerActionCollection extends Fayde.XamlObjectCollection<Fayde.TriggerAction> {
    }
    ...
    class TriggerCollection extends Fayde.XamlObjectCollection<Fayde.TriggerBase> {
...
declare module Fayde {
    class UINode extends Fayde.DONode {
        ...
        public _EmitMouseEvent(type: InputType, isLeftButton: boolean, isRightButton: boolean, args: Fayde.Input.MouseEventArgs): boolean;
...
declare module Fayde.Documents {
    ...
    class BlockCollection extends Fayde.XamlObjectCollection<Fayde.Documents.Block> {
        private _Listener;
...
declare module Fayde.Documents {
    ...
    class InlineCollection extends Fayde.XamlObjectCollection<Fayde.Documents.Inline> {
        private _Listener;
...
declare module Fayde {
    ...
    class FrameworkElement extends Fayde.UIElement implements Fayde.IResourcable, Fayde.IMeasurableHidden, Fayde.IArrangeableHidden, Fayde.Providers.IIsPropertyInheritable {
...
declare module Fayde.Shapes {
    class ShapeNode extends Fayde.FENode implements Fayde.IBoundsComputable, Fayde.IPostInsideObject {
        ...
        public GetStretchExtents(shape: Shape, lu: Fayde.LayoutUpdater): rect;
    }
    class Shape extends Fayde.FrameworkElement implements Fayde.IMeasurableHidden, Fayde.IArrangeableHidden, Fayde.IRenderable, Fayde.IActualSizeComputable {
        ...
        public _InvalidatePathCache(free?: boolean): void;
...
declare module Fayde.Controls {
    class BorderNode extends Fayde.FENode {
...
declare module Fayde.Controls {
    ...
    class ItemsControl extends Controls.Control {
        ...
        public InvokeItemsChanged(sender, e: Fayde.Collections.NotifyCollectionChangedEventArgs): void;
        ...
        public UpdateContentTemplateOnContainer(element: Fayde.DependencyObject, item): void;
    }
}
declare module Fayde.Controls {
...
declare module Fayde.Controls {
    class PanelNode extends Fayde.FENode implements Fayde.IBoundsComputable, Fayde.IPostInsideObject {
    ...
    class Panel extends Fayde.FrameworkElement implements Fayde.IMeasurableHidden {
...
declare module Fayde.Controls {
    class StackPanel extends Controls.Panel implements Fayde.IMeasurableHidden, Fayde.IArrangeableHidden {
...
declare module Fayde.Controls {
    class TextBlockNode extends Fayde.FENode implements Fayde.IBoundsComputable, Fayde.Documents.IInlinesChangedListener {
    ...
    class TextBlock extends Fayde.FrameworkElement implements Fayde.IMeasurableHidden, Fayde.IArrangeableHidden, Fayde.IRenderable, Fayde.IActualSizeComputable, Fayde.IFontChangeable {
...
declare module Fayde.Controls.Internal {
    class TextBoxViewNode extends Fayde.FENode {
        public XObject: TextBoxView;
        constructor(xobj: TextBoxView);
    }
    class TextBoxView extends Fayde.FrameworkElement implements Fayde.IMeasurableHidden, Fayde.IArrangeableHidden, Fayde.IRenderable, Fayde.IActualSizeComputable, Controls.ITextModelListener {
...
declare module Fayde.Controls {
    class UCNode extends Controls.ControlNode {
        public _IsParsing: boolean;
        public XObject: UserControl;
        constructor(xobj: UserControl);
        public GetDefaultTemplate(): Fayde.UIElement;
    }
    class UserControl extends Controls.Control implements Fayde.IMeasurableHidden, Fayde.IArrangeableHidden {
...
declare module Fayde.Controls {
    ...
    class VirtualizingStackPanel extends Controls.VirtualizingPanel implements Controls.Primitives.IScrollInfo, Fayde.IMeasurableHidden, Fayde.IArrangeableHidden {
        ...
        public SetHorizontalOffset(offset: number): void;
        public SetVerticalOffset(offset: number): void;
        public CleanUpVirtualizedItemEvent: Fayde.RoutedEvent<Fayde.Controls.CleanUpVirtualizedItemEventArgs>;
        static OrientationProperty: DependencyProperty;
        public Orientation: Fayde.Orientation;
...
declare module Fayde.Controls.Primitives {
    class PopupNode extends Fayde.FENode implements Fayde.IBoundsComputable, Fayde.IPostComputeTransformable {
        ...
        public PostCompute(lu: Fayde.LayoutUpdater, hasLocalProjection: boolean): void;
...
declare module Fayde.Controls.Primitives {
    class ScrollBar extends Primitives.RangeBase {
        private _DragValue;
        public Scroll: Fayde.RoutedEvent<Fayde.Controls.Primitives.ScrollEventArgs>;
        static OrientationProperty: DependencyProperty;
...
declare module Fayde.Controls.Primitives {
    class Selector extends Controls.ItemsControl {
        ...
        public SelectionChanged: Fayde.RoutedEvent<Fayde.Controls.Primitives.SelectionChangedEventArgs>;
...
declare module Fayde.Controls.Primitives {
    class Thumb extends Controls.Control {
        ...
        private _Origin;
        public DragCompleted: Fayde.RoutedEvent<Fayde.Controls.Primitives.DragCompletedEventArgs>;
        public DragDelta: Fayde.RoutedEvent<Fayde.Controls.Primitives.DragDeltaEventArgs>;
        public DragStarted: Fayde.RoutedEvent<Fayde.Controls.Primitives.DragStartedEventArgs>;
...
declare module Fayde.Controls {
    ...
    class Canvas extends Controls.Panel implements Fayde.IMeasurableHidden, Fayde.IArrangeableHidden {
...
declare module Fayde.Controls {
    class GridNode extends Controls.PanelNode {
        public XObject: Grid;
    ...
    class Grid extends Controls.Panel implements Fayde.IMeasurableHidden, Fayde.IArrangeableHidden, Controls.IRowDefinitionsListener, Controls.IColumnDefinitionsListener {
