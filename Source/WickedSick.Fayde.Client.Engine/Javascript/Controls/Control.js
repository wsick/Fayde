...
Control.FontFamilyProperty = DependencyProperty.RegisterInheritable("FontFamily", function () { return String; }, Control, Font.DEFAULT_FAMILY);
Control.FontSizeProperty = DependencyProperty.RegisterInheritable("FontSize", function () { return Number; }, Control, Font.DEFAULT_SIZE);
Control.FontStretchProperty = DependencyProperty.RegisterInheritable("FontStretch", function () { return String; }, Control, Font.DEFAULT_STRETCH);
Control.FontStyleProperty = DependencyProperty.RegisterInheritable("FontStyle", function () { return String; }, Control, Font.DEFAULT_STYLE);
Control.FontWeightProperty = DependencyProperty.RegisterInheritable("FontWeight", function () { return new Enum(FontWeight); }, Control, Font.DEFAULT_WEIGHT);
Control.ForegroundProperty = DependencyProperty.RegisterInheritable("Foreground", function () { return Brush; }, Control, undefined, undefined, { GetValue: function () { return new SolidColorBrush(new Color(0, 0, 0, 1.0)); } });
