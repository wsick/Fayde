...
var Mock1Property = DependencyProperty.Register("Mock1", () => { return String; }, Fayde.DependencyObject, "Default");

test("Test Basic Provider Storage", () => {
    var d = new Fayde.DependencyObject();
    var store = d._Store;
    store.SetProviders([null, new Fayde.Providers.LocalValueProvider(), null, null, null, null, null, new Fayde.Providers.DefaultValueProvider(), null]);
