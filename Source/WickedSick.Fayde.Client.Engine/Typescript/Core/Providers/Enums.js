...
(function (Fayde) {
    (function (Providers) {
        (function (_PropertyPrecedence) {
            ...
            _PropertyPrecedence.LocalStyle = 2;
            _PropertyPrecedence.ImplicitStyle = 3;
            _PropertyPrecedence.Inherited = 4;
            _PropertyPrecedence.InheritedDataContext = 5;
            _PropertyPrecedence.DefaultValue = 6;
            _PropertyPrecedence.Lowest = 6;
            _PropertyPrecedence.Highest = 0;
            _PropertyPrecedence.Count = 7;
