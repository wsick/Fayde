...
module Fayde.Input {
    export class KeyboardNavigation {
        ...
        static GetAcceptsReturn(d: DependencyObject): bool { return d.GetValue(KeyboardNavigation.AcceptsReturnProperty); }
        static SetAcceptsReturn(d: DependencyObject, value: bool) { d.SetValue(KeyboardNavigation.AcceptsReturnProperty, value); }
        ...
        static GetIsTabStop(d: DependencyObject): bool { return d.GetValue(KeyboardNavigation.IsTabStopProperty); }
        static SetIsTabStop(d: DependencyObject, value: bool) { d.SetValue(KeyboardNavigation.IsTabStopProperty, value); }
