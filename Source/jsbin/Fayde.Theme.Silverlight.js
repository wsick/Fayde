...
(function () {
    ...
    var PointAnimation = Fayde.Media.Animation.PointAnimation; if (!PointAnimation) throw new UnknownTypeException("Fayde.Media.Animation.PointAnimation");
    ...
    var FlowDirection = Fayde.FlowDirection; if (!FlowDirection) throw new UnknownTypeException("Fayde.FlowDirection");
    ...
    var RichTextBox = Fayde.Controls.RichTextBox; if (!RichTextBox) throw new UnknownTypeException("Fayde.Controls.RichTextBox");
                                    ...
                                    },
                                    {
                                        ...
                                        Content: {
                                            ...
                                            Children: [
                                            {
                                                ParseType: DoubleAnimation,
                                                Props: {
                                                    Duration: new Duration(TimeSpan.FromArgs(0, 0, 0, 0, 500)),
                                                    From: 0,
                                                    To: 20
                                                },
                                                AttachedProps: [{
            ...
            Value: {
                ...
                },
                {
                    ...
                    Props: {
                        ...
                        Value: new ControlTemplate(RichTextBox, {
                            ParseType: Grid,
                            Name: "RootElement",
                            AttachedProps: [{
                                Owner: VisualStateManager,
