...
define(["require", "exports"], function(require, exports) {
    function run() {
        ...
        test("Implicit DataTemplate", function () {
            var xaml = "<Grid xmlns=\"http://schemas.wsick.com/fayde\" xmlns:x=\"http://schemas.wsick.com/fayde/x\">" + "<Grid.Resources>" + "<DataTemplate TargetType=\"Color\">" + "<TextBlock Text=\"{Binding R}\" />" + "</DataTemplate>" + "</Grid.Resources>" + "<ContentControl Content=\"{x:Static new Color()}\">" + "</ContentControl>" + "</Grid>";
            var grid;
            try  {
