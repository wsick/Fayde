...
define(["require", "exports"], function(require, exports) {
    function run() {
        ...
        test("Virtualizing Non-UI Items", function () {
            var ic = new Fayde.Controls.ItemsControl();
            ic.ItemsPanel = Fayde.Xaml.Load(new Fayde.Xaml.XamlDocument("<ItemsPanelTemplate xmlns=\"" + Fayde.XMLNS + "\"><VirtualizingStackPanel /></ItemsPanelTemplate>").Document);
            ic.Measure(size.createInfinite());
            var icg = ic.ItemContainerGenerator;
