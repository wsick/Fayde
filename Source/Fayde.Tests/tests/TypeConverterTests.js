...
define(["require", "exports"], function(require, exports) {
    function run() {
        ...
        test("Enums", function () {
            strictEqual(Fayde.ConvertAnyToType("Top", (new Enum(Fayde.VerticalAlignment))), 0 /* Top */, "String to Enum");
        });
        ...
        test("TimeSpan", function () {
            ...
            ts = Fayde.ConvertAnyToType("00:00:00.001", TimeSpan);
        ...
        test("GridLength", function () {
            ...
            strictEqual(gl.Type, 0 /* Auto */, "Auto GridLength");
            gl = Fayde.ConvertAnyToType("3*", GridLength);
            strictEqual(gl.Type, 2 /* Star */, "Star GridLength Type");
            strictEqual(gl.Value, 3, "Star GridLength Value");
            gl = Fayde.ConvertAnyToType("25", GridLength);
            strictEqual(gl.Type, 1 /* Pixel */, "Pixel GridLength Type");
        ...
        test("ColumnDefinition", function () {
            ...
            strictEqual(cdw.Type, 0 /* Auto */, "1.2");

            cdw = cdc.GetValueAt(1).Width;
            strictEqual(cdw.Type, 2 /* Star */, "1.3");
            strictEqual(cdw.Value, 1, "1.4");

            cdw = cdc.GetValueAt(2).Width;
            strictEqual(cdw.Type, 1 /* Pixel */, "1.5");
            ...
            strictEqual(cdw.Type, 2 /* Star */, "2.2");
            strictEqual(cdw.Value, 3, "2.3");

            cdw = cdc.GetValueAt(1).Width;
            strictEqual(cdw.Type, 1 /* Pixel */, "2.4");
            strictEqual(cdw.Value, 100, "2.5");

            cdw = cdc.GetValueAt(2).Width;
            strictEqual(cdw.Type, 0 /* Auto */, "2.6");
            ...
            cdw = cdc.GetValueAt(0).Width;
            strictEqual(cdw.Type, 2 /* Star */, "3.2");
            ...
            cdw = cdc.GetValueAt(0).Width;
            strictEqual(cdw.Type, 0 /* Auto */, "4.2");
            ...
            cdw = cdc.GetValueAt(0).Width;
            strictEqual(cdw.Type, 1 /* Pixel */, "5.2");
        ...
        test("RowDefinition", function () {
            ...
            strictEqual(rdh.Type, 0 /* Auto */, "1.2");

            rdh = rdc.GetValueAt(1).Height;
            strictEqual(rdh.Type, 2 /* Star */, "1.3");
            strictEqual(rdh.Value, 1, "1.4");

            rdh = rdc.GetValueAt(2).Height;
            strictEqual(rdh.Type, 1 /* Pixel */, "1.5");
            ...
            strictEqual(rdh.Type, 2 /* Star */, "2.2");
            strictEqual(rdh.Value, 3, "2.3");

            rdh = rdc.GetValueAt(1).Height;
            strictEqual(rdh.Type, 1 /* Pixel */, "2.4");
            strictEqual(rdh.Value, 100, "2.5");

            rdh = rdc.GetValueAt(2).Height;
            strictEqual(rdh.Type, 0 /* Auto */, "2.6");
            ...
            rdh = rdc.GetValueAt(0).Height;
            strictEqual(rdh.Type, 2 /* Star */, "3.2");
            ...
            rdh = rdc.GetValueAt(0).Height;
            strictEqual(rdh.Type, 0 /* Auto */, "4.2");
            ...
            rdh = rdc.GetValueAt(0).Height;
            strictEqual(rdh.Type, 1 /* Pixel */, "5.2");
