...
define(["require", "exports", "../mocks/TestControl"], function(require, exports) {
    function run() {
        ...
        QUnit.asyncTest("Theme", 1, function () {
            var theme = Fayde.ConvertAnyToType("Theme.Metro.xml", Fayde.Theme);
            theme.Resolve().success(function (res) {
        ...
        test("VisualStateManager", function () {
            var xaml = "<Grid xmlns=\"http://schemas.wsick.com/fayde\" xmlns:x=\"http://schemas.wsick.com/fayde/x\">" + "<VisualStateManager.VisualStateGroups>" + "<VisualStateGroup x:Name=\"CommonStates\">" + "<VisualState x:Name=\"Normal\" />" + "</VisualStateGroup>" + "</VisualStateManager.VisualStateGroups>" + "</Grid>";
