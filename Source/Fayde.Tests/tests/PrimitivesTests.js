...
define(["require", "exports"], function(require, exports) {
    function run() {
        ...
        test("DateTime", function () {
            ...
            d = new DateTime(1000, 0 /* Local */);
            strictEqual(d.Ticks, 1000, "ctor3 ticks");
            strictEqual(d.Kind, 0 /* Local */, "ctor3 kind");
            ...
            d = new DateTime(2000, 1, 2, 5, 30, 45, 500, 2 /* Utc */);
            ...
            strictEqual(d.Kind, 2 /* Utc */, "ctor7 kind");
        ...
        test("DateTime: DaysInMonth", function () {
        ...
        test("Vector", function () {
            ...
            function vecEqual(v1, v2, message) {
