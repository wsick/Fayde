...
define(["require", "exports"], function(require, exports) {
    function run() {
        ...
        test("Inherited", function () {
            ...
            root2.Template = Fayde.Xaml.Load(new Fayde.Xaml.XamlDocument(xaml).Document);
            ...
            child2.Template = Fayde.Xaml.Load(new Fayde.Xaml.XamlDocument(xaml).Document);
            root2.ApplyTemplate();
        ...
        test("Styles", function () {
            ...
            strictEqual(val, 0 /* Visible */, "Child Visibility should default to Visible.");
            ...
            val = child.GetValue(Fayde.UIElement.VisibilityProperty);
            strictEqual(val, 1 /* Collapsed */, "Child Visibility should have changed to default by local style.");
            ...
            val = child.GetValue(Fayde.UIElement.VisibilityProperty);
            strictEqual(val, 0 /* Visible */, "After a new style is applied without Visibility property, Visibility revert to default value.");
        ...
        test("IsEnabled", function () {
            ...
            var xaml = "<ControlTemplate xmlns=\"" + Fayde.XMLNS + "\" xmlns:x=\"" + Fayde.XMLNSX + "\" TargetType=\"Control\"><Grid><Border x:Name=\"TheBorder\" /></Grid></ControlTemplate>";
            root.Template = Fayde.Xaml.Load(new Fayde.Xaml.XamlDocument(xaml).Document);
            ...
            child.Template = Fayde.Xaml.Load(new Fayde.Xaml.XamlDocument(xaml).Document);
