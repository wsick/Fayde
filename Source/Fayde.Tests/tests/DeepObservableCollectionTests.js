...
define(["require", "exports", "../mocks/TestObservable"], function(require, exports, TestObservable) {
    var DeepObservableCollection = Fayde.Collections.DeepObservableCollection;

    function run() {
        QUnit.module("DeepObservableCollection Tests");

        test("ItemPropertyChanged", function () {
            var doc = new DeepObservableCollection();
            ...
            function onItemPropertyChanged(sender, e) {
...
//# sourceMappingURL=DeepObservableCollectionTests.js.map
