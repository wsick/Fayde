...
module Fayde.Media.Animation {
    ...
    Fayde.RegisterType(DoubleKeyFrame, Fayde.XMLNS);
    ...
    Fayde.RegisterType(DiscreteDoubleKeyFrame, Fayde.XMLNS);
    ...
    Fayde.RegisterType(EasingDoubleKeyFrame, Fayde.XMLNS);
    ...
    Fayde.RegisterType(LinearDoubleKeyFrame, Fayde.XMLNS);
    ...
    Fayde.RegisterType(SplineDoubleKeyFrame, Fayde.XMLNS);
}