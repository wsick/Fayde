...
module Fayde.Shapes {
    ...
    module reactions {
        UIReaction<number>(Rectangle.RadiusXProperty, (upd, ov, nv) => {
            upd.invalidateMeasure();
            //TODO: Do we need this?
            //up.invalidatePathCache();
            upd.invalidate();
        }, false);
        UIReaction<number>(Rectangle.RadiusYProperty, (upd, ov, nv) => {
            upd.invalidateMeasure();
            //TODO: Do we need this?
            //up.invalidatePathCache();
            upd.invalidate();
    ...
    //TODO: Implement rectangle updater
    /*
